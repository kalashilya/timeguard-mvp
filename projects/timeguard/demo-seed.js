(() => {
  ...
  const demoTasks = () => [
    { id: uid(), date: today(), title: 'Разобрать учебный проект', start: '10:00', end: '11:30', priority: 'high', category: 'study', notes: 'Проверить MVP, README и сценарий защиты', done: true, createdAt: new Date().toISOString() },
    { id: uid(), date: today(), title: 'Подготовить демонстрацию Supabase', start: '12:00', end: '13:00', priority: 'high', category: 'work', notes: 'Показать синхронизацию и cloud-страницу', done: false, createdAt: new Date().toISOString() },
    { id: uid(), date: today(), title: 'Финальная репетиция защиты', start: '16:00', end: '17:00', priority: 'medium', category: 'meeting', notes: 'Пройти Demo Center по шагам', done: false, createdAt: new Date().toISOString() },
  ...
  function seedDemoData() {
    const profile = {
      name: 'Илья Калашников',
      email: 'demo@timeguard.local',
      role: 'admin',
      plan: 'plus',
